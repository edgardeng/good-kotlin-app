...
package com.edgar.movie.demo.activity.navigation
...
//            findNavController().navigate(R.id.flow_step_one_dest, null, options)
            getView()?.let { it1 -> Navigation.findNavController(it1).navigate(R.id.flow_step_one_dest, null, options) }
        }
        //TODO END STEP 6
...
//        getView()?.let { it1 -> Navigation.findNavController(it1).navigate(R.id.next_action, null) }
